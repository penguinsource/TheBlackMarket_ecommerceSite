	...
	<div class='main'>
		...
		<div style="position:relative;">
			...
			<div class='body'>		
				...
				<h2>FAQ</h2>
				Q: Why does it say that my email address is invalid?<br><br>
				<em>A: We check the email address that you enter to make sure it's in a valid format. 
				Please ensure that it's correct and try it again.</em><br><br>
